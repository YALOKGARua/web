...
(_a = _q1w2._e3r4) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => { var _a; return (_a = _q1w2._t5y6) === null || _a === void 0 ? void 0 : _a.classList.toggle('_act9'); });
window.addEventListener('resize', debounce(() => {
    var _a;
    if (window.innerWidth > 768)
        (_a = _q1w2._t5y6) === null || _a === void 0 ? void 0 : _a.classList.remove('_act9');
}, 100));
const _m0n1 = {
    en: {
        r4t5y6: "About Us",
...
function updateLanguage(lang) {
    document.querySelectorAll('[data-_v1]').forEach(element => {
        ...
        if (_m0n1[lang][key])
            element.innerHTML = _m0n1[lang][key];
    });
    document.documentElement.lang = lang;
}
let currentLang = localStorage.getItem('_l9k0') || 'uk';
const languageButton = document.getElementById('_m4n3b2');
function toggleLanguage() {
    currentLang = currentLang === 'en' ? 'uk' : 'en';
    if (languageButton)
        languageButton.textContent = currentLang === 'en' ? 'EN' : 'UA';
    updateLanguage(currentLang);
    localStorage.setItem('_l9k0', currentLang);
    updateVisitCounter();
}
languageButton === null || languageButton === void 0 ? void 0 : languageButton.addEventListener('click', toggleLanguage);
if (languageButton)
    languageButton.textContent = currentLang === 'en' ? 'EN' : 'UA';
updateLanguage(currentLang);
...
(_b = document.getElementById('_theme-toggle')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', toggleTheme);
...
Object.entries(modals).forEach(([modalId, triggerClass]) => {
    ...
    const closeButton = modal === null || modal === void 0 ? void 0 : modal.querySelector('._m0n9b8__shut');
...
const formValidations = {
    ...
    '_y6u5t4': (form, name, phone, msgElement) => {
        ...
        const role = form.querySelector('#_j4k3l2').value;
...
Object.keys(formValidations).forEach(formId => {
    ...
    form === null || form === void 0 ? void 0 : form.addEventListener('submit', function (event) {
        event.preventDefault();
        const nameInput = this.querySelector(`#${formId}-name`);
        const phoneInput = this.querySelector(`#${formId}-phone`);
        const msgElement = this.querySelector(`#${formId}-msg`) || this.querySelector('p:last-child');
...
if (_q1w2._d3f4) {
    ...
    if (ctx && _q1w2._d3f4 instanceof HTMLCanvasElement) {
        ...
        const particles = Array.from({ length: 100 }, () => {
            var _a, _b;
            return ({
                _x: Math.random() * (((_a = _q1w2._d3f4) === null || _a === void 0 ? void 0 : _a.width) || window.innerWidth),
                _y: Math.random() * (((_b = _q1w2._d3f4) === null || _b === void 0 ? void 0 : _b.height) || window.innerHeight),
                _sz: Math.random() * 5 + 2,
        ...
        function animateParticles() {
            if (!ctx || !_q1w2._d3f4 || !(_q1w2._d3f4 instanceof HTMLCanvasElement))
                return;
            ...
            particles.forEach(particle => {
                ...
                if (_q1w2._d3f4 && (particle._x > _q1w2._d3f4.width || particle._x < 0))
                    particle._sx *= -1;
                if (_q1w2._d3f4 && (particle._y > _q1w2._d3f4.height || particle._y < 0))
                    particle._sy *= -1;
...
function updateVisitCounter() {
    ...
    if (counter)
        counter.textContent = `${_m0n1[currentLang]['visits']}: ${visits}`;
}
(_c = document.getElementById('_scroll-top')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
